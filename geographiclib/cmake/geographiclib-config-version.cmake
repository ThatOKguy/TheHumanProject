...
set (PACKAGE_VERSION "1.52")
set (PACKAGE_VERSION_MAJOR "1")
set (PACKAGE_VERSION_MINOR "52")
...
elseif (MSVC AND NOT (
    ...
    MSVC_TOOLSET_VERSION GREATER_EQUAL 140
    # and major versions must match
    AND MSVC_TOOLSET_MAJOR EQUAL 14 ))
  # Reject if there's a mismatch in MSVC compiler versions
  set (REASON "MSVC_TOOLSET_VERSION = 140")
  set (PACKAGE_VERSION_UNSUITABLE TRUE)
...
set (GeographicLib_NETGeographicLib_FOUND ON)
